...
<input type="hidden" id="_wpnonce" name="_wpnonce" value="674bd168b0" /><input type="hidden" name="_wp_http_referer" value="<?php get_bloginfo('wpurl'); ?>/wp-admin/page-new.php" />
...
<input type='hidden' id='post_ID' name='temp_ID' value='-1228969046' />
<input type="hidden" id="post_type" name="post_type" value="page" />
<input type="hidden" id="original_post_status" name="original_post_status" value="draft" />
<input name="referredby" type="hidden" id="referredby" value="<?php get_bloginfo('wpurl'); ?>/wp-admin/admin.php?page=wikipress" />

<div id="poststuff" class="metabox-holder has-right-sidebar">

<div id="side-info-column" class="inner-sidebar">
<h2><img src="<?php get_bloginfo('wpurl'); ?>/wp-content/plugins/wikipress/assets/images/wikipress-logo.png" style="border:none;background:none;width:150px;display:inline;padding-right:5px;margin-bottom:-7px;" /></h2>
<div id='side-sortables' class='meta-box-sortables'>
	<div id="pagesubmitdiv" class="postbox " >
	<div class="handlediv" title="Click to toggle"><br /></div><h3 class='hndle'><span>About This WikiBoard</span></h3>
	<div class="inside">
...
?>	<p style="padding:0 10px;">This WikiBoard was created <strong><em><?php echo date("F jS, Y", strtotime($wiki_birthday));?></em></strong> by <strong><em><?php author_meta($wiki_king); ?>.</em></strong></p><br><a href="<?php get_bloginfo('wpurl'); ?>/wp-admin/admin.php?page=wikipress">&larr; Back to Dashboard</a>
</div>
			</div>
			<div class="clear"></div>
			</div>
...
<div class="handlediv" title="Click to toggle"></div><h3 class='hndle'><span>Archived Versions</span></h3>
<div class="inside" >
<?php
...
<table>
	...
	<?php
$this->archive_rows($current['wiki_id']);
	?>
	</table>
