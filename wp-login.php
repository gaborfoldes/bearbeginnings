...
<?php   if ( !is_multisite() ) { ?>
<div id="login"><h1><a href="." title="<?php bloginfo('name'); ?>"><?php bloginfo('name'); ?></a></h1>
...
function register_new_user( $user_login, $user_email ) {
	...
	} elseif ( substr(strtolower($user_email),-12) != 'berkeley.edu' ) {
		$errors->add( 'email_not_allowed', __( '<strong>ERROR</strong>: Please use your "berkeley.edu" email address.' ) );
	}
...
case 'register' :
	...
	login_header(__('Registration Form'), '<p class="message register">' . __('<b>Register for the site</b><br>The site is currently only open to the UC Berkeley community.  You must use your "berkeley.edu" email to register.') . '</p>', $errors);
?>
...
default:
	...
	if ( isset( $_REQUEST['redirect_to'] ) ) {
		...
		$redirect_to = site_url(); #admin_url();
	}
