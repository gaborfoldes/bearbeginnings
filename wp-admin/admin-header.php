...
<img id="header-logo" src="<?php echo esc_url( includes_url( 'images/blank.gif' ) ); ?>" alt="" width="32" />
...
<p><?php
$links = array();
$links[5] = sprintf(__('Hello <a href="%1$s" title="Edit your profile">%2$s</a>'), 'profile.php', $user_identity);
